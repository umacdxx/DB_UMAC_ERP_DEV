CREATE TABLE [dbo].[PD_SET_RESULT_PROD] (
    ...
    [PROD_CFM_FLAG] NVARCHAR (2)  CONSTRAINT [DF_PD_SET_RESULT_PROD_CFM_FLAG] DEFAULT (N'N') NOT NULL,
    [IDATE]         DATETIME      NOT NULL,
    [IEMP_ID]       NVARCHAR (20) NOT NULL,
    [UDATE]         DATETIME      NULL,
    [UEMP_ID]       NVARCHAR (20) NULL,
    CONSTRAINT [PK__PD_SET_R__4809F8CA3428518F] PRIMARY KEY CLUSTERED ([SET_PLAN_ID] ASC, [PROD_DT] ASC, [SCAN_CODE] ASC)
);

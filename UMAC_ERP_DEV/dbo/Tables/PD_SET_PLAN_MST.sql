CREATE TABLE [dbo].[PD_SET_PLAN_MST] (
    ...
    CONSTRAINT [PK__PD_SET_P__6FDD1DB01C0306B5] PRIMARY KEY CLUSTERED ([SET_PLAN_ID] ASC),
    CONSTRAINT [CK__PD_SET_PL__SET_S__797DF6D1] CHECK ([SET_STATUS]='3' OR [SET_STATUS]='2' OR [SET_STATUS]='1' OR [SET_STATUS]='0')
);

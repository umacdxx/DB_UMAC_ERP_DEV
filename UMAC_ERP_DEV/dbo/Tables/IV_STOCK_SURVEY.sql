CREATE TABLE [dbo].[IV_STOCK_SURVEY] (
    ...
    [IDATE]        DATETIME      CONSTRAINT [DF__IV_STOCK___IDATE__3508D0F3] DEFAULT (getdate()) NOT NULL,
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'1.수기 2. EXCEL 3.PDA', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'IV_STOCK_SURVEY', @level2type = N'COLUMN', @level2name = N'INV_FLAG';
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'LOT 번호', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'IV_STOCK_SURVEY', @level2type = N'COLUMN', @level2name = N'LOT_NO';

...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'첨부서류 비고', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'PO_ORDER_HDR', @level2type = N'COLUMN', @level2name = N'DOCUMENT_REMARKS';

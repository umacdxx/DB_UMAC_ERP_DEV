...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'PA_ACC_DEPOSIT.IDATE', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'PA_ACCT_DEPOSIT_DEL_LOG', @level2type = N'COLUMN', @level2name = N'IDATE';

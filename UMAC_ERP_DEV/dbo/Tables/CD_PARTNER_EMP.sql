...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'알림톡 사용 여부', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CD_PARTNER_EMP', @level2type = N'COLUMN', @level2name = N'ALIMTALK_YN';

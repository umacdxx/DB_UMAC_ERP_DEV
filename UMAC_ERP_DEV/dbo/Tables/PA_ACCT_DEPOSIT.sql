CREATE TABLE [dbo].[PA_ACCT_DEPOSIT] (
    ...
    CONSTRAINT [PK_PA_ACCT_DEPOSIT] PRIMARY KEY CLUSTERED ([MOID] ASC)
);
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'카드번호(안심키 카드정보 NO RETURN)', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'PA_ACCT_DEPOSIT', @level2type = N'COLUMN', @level2name = N'CARD_NO';

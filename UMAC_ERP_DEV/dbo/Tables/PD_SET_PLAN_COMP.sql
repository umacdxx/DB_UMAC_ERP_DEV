CREATE TABLE [dbo].[PD_SET_PLAN_COMP] (
    ...
    CONSTRAINT [PK__PD_SET_P__B820076462A15BB1] PRIMARY KEY CLUSTERED ([SET_PLAN_ID] ASC, [SCAN_CODE] ASC, [SET_CD] ASC, [SET_COMP_CD] ASC),
    CONSTRAINT [CK__PD_SET_PL__SET_C__7E42ABEE] CHECK ([SET_CD]>='001' AND [SET_CD]<='999')
);

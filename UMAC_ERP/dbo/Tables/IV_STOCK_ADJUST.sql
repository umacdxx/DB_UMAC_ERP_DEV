...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'변경할 SEQ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'IV_STOCK_ADJUST', @level2type = N'COLUMN', @level2name = N'CH_SEQ';

...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'상품명', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CD_PRODUCT_CMN', @level2type = N'COLUMN', @level2name = N'ITM_NAME_DETAIL';

CREATE TABLE [dbo].[PD_SET_RESULT_COMP] (
    ...
    [COMP_CFM_FLAG] NVARCHAR (2)  NULL,
    [IDATE]         DATETIME      NOT NULL,
    [IEMP_ID]       NVARCHAR (20) NOT NULL,
    [UDATE]         DATETIME      NULL,
    [UEMP_ID]       NVARCHAR (20) NULL,
    CONSTRAINT [PK__PD_SET_R__AA716A244A6A5AA9] PRIMARY KEY CLUSTERED ([SET_PLAN_ID] ASC, [SEQ] ASC),
    CONSTRAINT [CK__PD_SET_RE__RESTO__127EAEC5] CHECK ([RESTORE_YN]='N' OR [RESTORE_YN]='Y')
);
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'자재 생산 확정 구분', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'PD_SET_RESULT_COMP', @level2type = N'COLUMN', @level2name = N'COMP_CFM_FLAG';

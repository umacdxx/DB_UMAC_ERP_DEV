...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'상품 코', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SL_SALE_ITEM', @level2type = N'COLUMN', @level2name = N'SCAN_CODE';


GO

EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'판매일', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SL_SALE_ITEM', @level2type = N'COLUMN', @level2name = N'SALE_DT';
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'상품 관코드', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SL_SALE_ITEM', @level2type = N'COLUMN', @level2name = N'ITM_CODE';
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'PICKING_AMT 합', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SL_SALE_ITEM', @level2type = N'COLUMN', @level2name = N'SALE_TOTAL_AMT';

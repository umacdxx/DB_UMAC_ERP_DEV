...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'과면세구분', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SL_SALE', @level2type = N'COLUMN', @level2name = N'TAX_GB';
